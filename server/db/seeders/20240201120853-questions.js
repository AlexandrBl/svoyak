...
module.exports = {
  async up(queryInterface) {
    await queryInterface.bulkInsert('Questions', [
      ...
      {
        question_text: 'Что просит включить Абубакар когда проигрывает в теннис?',
        theme_id: 3,
        salary: 300,
        createdAt: new Date(),
        updatedAt: new Date(),
      ...
      {
        question_text: 'Что написано на входе в TYPESCRIPT?',
        theme_id: 3,
        salary: 400,
        createdAt: new Date(),
        updatedAt: new Date(),
      ...
      {
        question_text: 'Почему Эльбрус называется именно так?',
        theme_id: 3,
        salary: 1500,
        createdAt: new Date(),
        updatedAt: new Date(),
